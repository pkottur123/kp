  ...
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full bg-black">
      ...
      <div className="absolute z-[20] bottom-[10px] px-[5px]">
        <div className="cursive text-[15px] font-medium text-center text-gray-300"></div>
      </div>
        ...
        <video
          ...
          playsInline
          preload="false"
          className="w-full h-auto opacity-25" // Hides the video if it's causing the blue tint
          src="/video1.webm/"
        />
      </div> 
    </div>
